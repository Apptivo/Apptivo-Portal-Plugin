...
if($status->statusName=="Resolved"){
		$resolved_status_id=$status->statusId;
	}
}

//echo $status_id;
$customerId=$_SESSION['customerId'];
$myCases=get_all_closed_tickets($closed_status_id,$resolved_status_id,$customerId); 
