...
foreach($statuses as $status){
	if($status->statusName=="Client Action Required"){
...
$myCases=get_all_pending_tickets($status_id,$customerId); //po1($myCases);
...
if($emailId==''){
    ...
    $edit_case_url=esc_url( get_permalink( get_page_by_title( OBJECT_NAME.' Edit' ) ) );
?>
