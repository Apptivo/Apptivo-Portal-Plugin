...
class apptivoApi
{
	...
	function update($app, $objectId, $attributeName, $objectData, $extraParams) {
		...
		logIt($api_url.'    with post data: '.http_build_query(array($objParams['objectDataName'] => $objectData)),false,'api.log.txt');
		curl_setopt($this->ch,CURLOPT_URL, $api_url);
